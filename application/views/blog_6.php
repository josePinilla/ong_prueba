        ...
        <div class="container">
            ...
            <div class="mainbody">
                ...
                <div class="col-sm-8 col-xs-12">
                    <p class="p-azul-2">Microemprendedores</p>
                </div>
                <div class="col-sm-4">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <picture>
                            <center>
                                <img class="img-tam-blogs" style="max-width: 100%; height: auto; width: auto/9;" src="<?= base_url() ?>template/tools/ong/image/blog/Microemprendedor_blog.png" alt="Imagen no encontrada"/>
                            </center>
                        </picture>
                    </div>
                    <br>
