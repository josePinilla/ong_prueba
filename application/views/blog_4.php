        ...
        <div class="container">
            ...
            <div class="mainbody">
                ...
                <div class="col-sm-8 col-xs-12">
                    <p class="p-azul-2">Mujer Familia, estudio y Trabajo</p>
                     <p class="p-azul-2">Equilibrio Perfecto</p>
                </div>
                <div class="col-sm-4">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <picture>
                            <center>
                                <img class="img-tam-blogs" style="max-width: 100%; height: auto; width: auto/9;" src="<?= base_url() ?>template/tools/ong/image/blog/Equilibrio_blog.png" alt="Imagen no encontrada"/>
                            </center>
                        </picture>
                    </div>
                    <br>
                    <div class="col-sm-4">
                        ...
                        <div class="list-group">
                            ...
                            <form role="form" action="<?= base_url()?>Blog/blog_3" method="POST">
                                <button type="submit" class="list-group-item">Equidad de Género</button>
                            </form>
                            <form role="form" action="<?= base_url()?>Blog/blog_5" method="POST">
                                <button type="submit" class="list-group-item">La Mujer como Jefa de Hogar</button>
                            </form>
