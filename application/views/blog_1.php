    ...
    <body>
        <div class="container">
            ...
            <div class="mainbody">
                ...
                <br>
                <div class="col-sm-8">
                    <p class="p-azul-2">La felicidad, un tema de elección</p>
                </div>
                <div class="col-sm-4">
                   
                </div>
                <div class="col-sm-8">
                    <p style="margin-left: 73%; color: blue; font-size: 13px;">Por: Nicolás Gandolfo</p>
                </div>
                <br>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <picture>
                            <center>
                                <img class="img-tam-blogs" style="max-width: 100%; height: auto; width: auto/9;" src="<?= base_url() ?>template/tools/ong/image/blog/Feliz_blog.png" alt="Imagen no encontrada"/>
                            </center>
                        </picture>
                    </div>
                    <br>
                    <div class="col-sm-4">
                        ...
                        <div class="list-group">
                            <form role="form" action="<?= base_url()?>Blog/blog_2" method="POST">
                                <button type="submit" class="list-group-item btn-ultimos-blogs">Violencia Intrafamiliar</button>
                            </form>
                            <form role="form" action="<?= base_url()?>Blog/blog_3" method="POST">
                                <button type="submit" class="list-group-item btn-ultimos-blogs">Equidad de Género</button>
                            </form>
                            <form role="form" action="<?= base_url()?>Blog/blog_4" method="POST">
                                <button type="submit" class="list-group-item btn-ultimos-blogs">Mujer Familia, estudio y Trabajo.Equilibrio Perfecto</button>
                            </form>
                            <form role="form" action="<?= base_url()?>Blog/blog_5" method="POST">
                                <button type="submit" class="list-group-item btn-ultimos-blogs">La Mujer como Jefa de Hogar</button>
                            </form>
                            <form role="form" action="<?= base_url()?>Blog/blog_6" method="POST">
                                <button type="submit" class="list-group-item btn-ultimos-blogs">Microemprendedores</button>
                            </form>
                          </div>
                    </div>
                    <br>
